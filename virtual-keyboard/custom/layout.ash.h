...
static struct key keys_full[] = {
  ...
  {"/", "?", .75, Code, KEY_SLASH, .scheme = 1},
  {"\\", "|", .75, Code, KEY_BACKSLASH, .scheme = 1},
  {"-", "_", 1.0, Code, KEY_MINUS},
  {"=", "+", 1.0, Code, KEY_EQUAL},
  {"⌫", "⌫", 1.5, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"`", "~", .5 , Code, KEY_GRAVE,&layouts[Special]},
  {"1", "!", 1.0, Code, KEY_1},
  {"2", "@", 1.0, Code, KEY_2},
  {"3", "#", 1.0, Code, KEY_3},
  {"4", "$", 1.0, Code, KEY_4},
...
//  {"", "", 0.5, Pad},
  {"Tab", "Tab", .75 , Code, KEY_TAB, .scheme = 1},
  ...
  {";", ":", .5, Code, KEY_SEMICOLON, .scheme = 1},
  {"'", "\"", .5, Code, KEY_APOSTROPHE, .scheme = 1},
  {"", "", 0.0, EndRow},
...
static struct key keys_special[] = {
  {"view", "move", 1.0, Mod, Shift, .scheme = 1},
  {"1", "1", 1.0, Code, KEY_MACRO1},
  {"2", "2", 1.0, Code, KEY_MACRO2},
  {"3", "3", 1.0, Code, KEY_MACRO3},
  {"4", "4", 1.0, Code, KEY_MACRO4},
  {"5", "5", 1.0, Code, KEY_MACRO5},
  {"6", "6", 1.0, Code, KEY_MACRO6},
  {"7", "7", 1.0, Code, KEY_MACRO7},
  {"8", "8", 1.0, Code, KEY_MACRO8},
  {"9", "9", 1.0, Code, KEY_MACRO9},
  {"", "", 0.0, EndRow},
  {"Esc", "Esc", 1.0, Code, KEY_ESC, .scheme = 1},
  {"Ctr", "Ctr", 1.0, Mod, Ctrl, .scheme = 1},
